...
-- Dumping data for table ayusha_pharmacy.invoice: ~11 rows (approximately)
...
-- Dumping data for table ayusha_pharmacy.invoice_item: ~9 rows (approximately)
...
INSERT INTO `product` (`id`, `product`, `generic_name`, `sale_price`, `cost_price`, `discount`, `measure`, `bar_code`, `product_unit_id`, `brand_id`, `product_status_id`) VALUES
	...
	(8, 'CLARITHROMYCIN 250mg TAB', 'CLARITHROMYCIN 250mg TAB', 4200, 3647, 100, 100, NULL, 5, 6, 1),
...
-- Dumping data for table ayusha_pharmacy.session: ~5 rows (approximately)
